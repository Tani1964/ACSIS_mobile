  ...
  const NotificationsInfo = () => {
    ...
    const fetchNotifications = async () => {
      ...
      try {
        ...
        const params = { filter: dateFilter }; // Add date filter to request
    ...
    useEffect(() => {
        authState.authenticated && fetchNotifications();
      authState.authenticated && markNotificationsAsRead();
    }, [dateFilter]); // Refetch notifications whenever date filter changes
